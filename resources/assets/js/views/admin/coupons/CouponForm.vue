        ...
        <form>
          <div class="card">
            ...
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="form-group col-md-3">
                  <label :style="errors.has('coupons.discount') ? 'color:red;' : ''">
                    ...
                    ? errors.first('coupons.discount') : 'Giảm % (discount) *'}}
                  </label>
                  <input
                    type="number"
              ...
              <br />
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Trạng thái phiếu giảm giá:</label>
                <div class="col-sm-9">
                  <button
                    v-if="coupons.status == 1"
                    type="button"
                    @click="updateStatus(1)"
                    v-tooltip.top-center="'Click để thay đổi trạng thái'"
                    class="btn btn-sm btn-icon btn-primary custom-btn"
                  >Đang chạy</button>
                  <button
                    v-else
                    type="button"
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Áp dụng cho:</label>
                <div class="col-sm-3 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="isAllRoom"
                  />
                  <label class="custom-control-label" for="isAllRoom">Tất cả phòng/căn hộ</label>
                </div>
              </div>
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Chọn các phòng/căn hộ:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 12"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      ...
                      >{{ values.length }} phòng/căn hộ đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="rooms"
                  />
                  <label class="custom-control-label style-checkbox" for="rooms"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Chọn các quản lý phòng:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 11"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      <span
                        ...
                        style="color:#ff6666"
                        v-if="values.length &amp;&amp; !isOpen"
                      >{{ values.length }} quản lý phòng đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="merchants"
                  />
                  <label class="custom-control-label style-checkbox" for="merchants"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Chọn các khách hàng:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 10"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      <span
                        ...
                        style="color:#660066"
                        v-if="values.length &amp;&amp; !isOpen"
                      >{{ values.length }} khách hàng đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="users"
                  />
                  <label class="custom-control-label style-checkbox" for="users"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Chọn các tỉnh/thành phố:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 9"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      <span
                        ...
                        style="color:blue"
                        v-if="values.length &amp;&amp; !isOpen"
                      >{{ values.length }} tỉnh/thành phố đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="cities"
                  />
                  <label class="custom-control-label style-checkbox" for="cities"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Chọn các quận/huyện:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 8"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      <span
                        ...
                        style="color:#ff0066"
                        v-if="values.length &amp;&amp; !isOpen"
                      >{{ values.length }} quận/huyện đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="districts"
                  />
                  <label class="custom-control-label style-checkbox" for="districts"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Áp dụng cho các loại phòng:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 7"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      <span
                        ...
                        style="color:#007c91"
                        v-if="values.length &amp;&amp; !isOpen"
                      >{{ values.length }} loại phòng đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="room_type"
                  />
                  <label class="custom-control-label style-checkbox" for="room_type"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                ...
                >Áp dụng cho các ngày trong tuần:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 6"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      <span
                        ...
                        style="color:#6b9b37"
                        v-if="values.length &amp;&amp; !isOpen"
                      >{{ values.length }} ngày trong tuần đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="days_of_week"
                  />
                  <label class="custom-control-label style-checkbox" for="days_of_week"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label">Áp dụng cho các loại booking:</label>
                <div class="col-sm-8">
                  <multiselect
                    style="z-index: 5"
                  ...
                  >
                    <template slot="selection" slot-scope="{ values, search, isOpen }">
                      <span
                        ...
                        style="color:#ee98fb"
                        v-if="values.length &amp;&amp; !isOpen"
                      >{{ values.length }} loại booking đã được chọn</span>
                    </template>
                  </multiselect>
                </div>
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="booking_type"
                  />
                  <label class="custom-control-label style-checkbox" for="booking_type"></label>
                </div>
              </div>
              <div
                class="form-group row wrapper-room panel-collapse custom-panel"
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="min_price"
                  />
                  <label class="custom-control-label style-checkbox" for="min_price"></label>
                </div>
              </div>
              <br />

              <div class="form-group row">
                <label for="pasword" class="col-sm-3 col-form-label pt-35">Áp dụng cho các ngày:</label>
                <div class="col-sm-8">
                  <v-date-picker
                    mode="multiple"
                ...
                <div class="col-sm-1 custom-checkbox-all custom-control custom-checkbox">
                  <input
                    ...
                    id="days"
                  />
                  <label class="custom-control-label style-checkbox" for="days"></label>
                </div>
              </div>
              <br />
              ...
              <div class="form-group row" v-if="promotionId == 0">
                ...
                >
                  <input
                    ...
                    id="coupon_create"
                  />
                  <label class="custom-control-label style-checkbox" for="coupon_create"></label>
                </div>
              </div>
              <br />
              <div class="form-group row">
                <label
                  ...
                  class="col-sm-3 col-form-label"
                  style="padding-top: 35px;"
                >Áp dụng cho ngày tạo booking:</label>
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>Từ</label>
                    <datepicker
                ...
                >
                  <input
                    ...
                    id="booking_create"
                  />
                  <label class="custom-control-label style-checkbox" for="booking_create"></label>
                </div>
              </div>
              <br />
              ...
              <div class="form-group row">
                <label
                  ...
                  class="col-sm-3 col-form-label"
                  style="padding-top: 35px;"
                >Áp dụng cho ngày khách ở:</label>
                <div class="col-sm-4">
                  <div class="form-group">
                    <label>Từ</label>
                    <datepicker
                ...
                >
                  <input
                    ...
                    id="booking_stay"
                  />
                  <label class="custom-control-label style-checkbox" for="booking_stay"></label>
                </div>
              </div>
              <br />
              ...
              <div class="btn-center">
                <button
                  :disabled="coupons.used > 0 ? true : false"
  ...
  methods: {
    setInitData() {
      ...
      this.coupons = JSON.parse(
        JSON.stringify({ ...this.coupons, ...dataCoupon }),
      );
      if (dataCoupon.settings.days.length) {
        this.coupons.settings.days = [];
        dataCoupon.settings.days.forEach(item => {
      ...
      if (dataCoupon.settings.booking_create.length > 1) {
        let {
          0: start,
          [dataCoupon.settings.booking_create.length - 1]: end,
      ...
      if (dataCoupon.settings.booking_stay.length > 1) {
        let {
          0: start,
          [dataCoupon.settings.booking_stay.length - 1]: end,
      ...
      if (result) {
        try {
              ...
              preConfirm: async () => {
                let response = await axios
                  .put(`coupons/${this.$route.params.couponId}`, {
                    ...
                    promotion_id:
                      this.promotionId != 0 ? this.promotionId : null,
                    status: this.coupons.status,
                    settings: {
                      bind:
                        this.isAllRoom == 0 ? this.coupons.settings.bind : [],
                      ...
                      booking_type:
                        this.isAllRoom == 0 ? arrBookingTypeId : null,
                      booking_create:
                        this.isAllRoom == 0 ? [startBCreate, endBCreate] : [],
                      booking_stay:
                        this.isAllRoom == 0 ? [startBStay, endBStay] : [],
                  ...
                  .post('coupons', {
                    ...
                    settings: {
                      ...
                      booking_create:
                        this.isAllRoom == 0 ? [startBCreate, endBCreate] : [],
                      // coupon_create:
                      //   this.isAllRoom == 0 && this.promotionId == 1
          ...
          if (error) {
            this.$swal(
              'Xin lỗi',
              'Mã giảm giá chưa đưọc lưu, làm ơn kiểm tra lại thông tin',
              'error',
            );
          }
        }
