              ...
              <div class="panel-group">
                <v-collapse>
                  <div class="panel panel-default">
                    <v-collapse-item>
                      <a slot="item-title" class="panel-title" href="#description">Mô tả</a>

                      <div
                        v-html="room_details.description"
                        id="description"
                        class="panel-collapse panel-content"
                      ></div>
                    </v-collapse-item>
                  </div>
                  <div class="panel panel-default">
                    <v-collapse-item>
                      <a slot="item-title" class="panel-title" href="#space">Không gian</a>

                      <div v-html="room_details.space" id="space" class="panel-collapse"></div>
                    </v-collapse-item>
                  </div>
                  <div class="panel panel-default">
                    <v-collapse-item>
                      <a slot="item-title" class="panel-title" href="#note">Ghi chú</a>

                      <div
                        v-html="room_details.note"
                        id="note"
                        class="panel-collapse panel-content"
                      ></div>
                    </v-collapse-item>
              ...
              <table class="table">
                <tbody>
                  ...
                  <tr>
                    <td>Phụ thu khách</td>
                    <td>
                      {{room.price_charge_guest | formatNumber}} ( từ sau
    ...
    async getRoom() {
      try {
        const response = await axios.get(`rooms/${this.$route.params.roomId}`, {
          params: {
            include:
              'details,media,comforts.details,city,district,prices,user,places',
          },
        });
