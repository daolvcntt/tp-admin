          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group row">
                <label for="firstName" class="col-sm-3 col-form-label">Tên bô sưu tập</label>
                <div class="col-sm-9">
                  <input
            ...
            >
              ...
              <td class="cell-fav">
                <div class="content-subject mb-3">
                  ...
                  >
                    <i
                      :class="collection.new == 1? 'icon-fa icon-fa-check color-green' : 'icon-fa icon-fa-times color-red'"
                    ></i>
                  </button>
                </div>
                <div class="content-subject mb-3">
                  ...
                  >
                    <i
                      :class="collection.hot == 1? 'icon-fa icon-fa-check color-green' : 'icon-fa icon-fa-times color-red'"
                    ></i>
                  </button>
                </div>
                <div class="content-subject mb-3">
                  ...
                  >
                    <i
                      :class="collection.status == 1? 'icon-fa icon-fa-check color-green' : 'icon-fa icon-fa-times color-red'"
                    ></i>
                  </button>
                </div>
              </td>
              <td width="10%" style="text-align:center">
                <div class="btn-group mb-3" role="group" aria-label="First group">
                  ...
                  <router-link
                    :to="{ name: 'collection.update',params: { collectionId: collection.id }}"
                  >
                    <button
