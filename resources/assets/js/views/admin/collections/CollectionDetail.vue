            ...
            <div class="card-body">
              ...
              <tabs class="tabs-default">
                <tab id="vi" name="Tiếng việt">
                  <p>
                    <b>
                      <h4>{{collection.vi.name}}</h4>
                    </b>
                  </p>
                  <p v-html="collection.vi.description"></p>
                </tab>
                <tab id="en" name="Tiếng anh">
                  <p>
                    <b>
                      <h4>{{collection.en.name}}</h4>
                    </b>
                  </p>
                  <p v-html="collection.en.description"></p>
                </tab>
              </tabs>
              ...
              <div class="col-sm-12 row">
                <p class="col-sm-4">
                  <i
                    :class="collection.status == 1? 'icon-fa icon-fa-check-square color-green' : 'icon-fa icon-fa-times color-red'"
                  ></i>
                  Trạng thái
                </p>
                <p class="col-sm-4">
                  <i
                    :class="collection.hot == 1? 'icon-fa icon-fa-check-square color-green' : 'icon-fa icon-fa-times color-red'"
                  ></i>
                  Nổi bật
                </p>
                <p class="col-sm-4">
                  <i
                    :class="collection.new == 1? 'icon-fa icon-fa-check-square color-green' : 'icon-fa icon-fa-times color-red'"
                  ></i>
                  Mới nhất
                </p>
              </div>
          ...
          <div class="card-body my-gallery" style="padding-left: 0px">
            ...
            <div class="image-gallery">
              <div class="row">
                ...
                >
                  <img :src="image" class="demo image img-fluid" @click="imgIndex = bindex" />
                </figure>
              </div>
            </div>
          </div>
