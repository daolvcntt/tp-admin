          ...
          <div class="card-body">
            <form @submit.prevent="editUser">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-3">
                  <label for="inputUserName">Chủ TK</label>
                  <input
                    id="inputUserName"
                    type="text"
                    readonly
                    v-model="user.account_holder"
                    class="form-control"
                    placeholder="Tên chủ Tài khoản"
                  />
                </div>
                <div class="form-group col-md-3">
                  <label for="inputUserName">Số TK</label>
                  <input
                    id="inputUserName"
                    type="number"
                    readonly
                ...
                <div class="form-group col-md-3">
                  <label for="inputUserName">Chi nhánh</label>
                  <input
                    id="inputUserName"
                    type="number"
                    readonly
                    v-model="user.account_branch"
                    class="form-control"
                    placeholder="Bank"
                  />
                </div>
