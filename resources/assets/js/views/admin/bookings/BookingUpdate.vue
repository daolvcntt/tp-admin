            ...
            <form @submit.prevent="onSubmit">
              <div class="form-row">
                ...
                <div class="form-group col-md-3">
                  ...
                  <input
                    disabled
                    type="text"
                    v-model="booking.booking_type_txt"
                    class="form-control"
                  />
                </div>
                <div class="form-group col-md-3">
                  ...
                  <input
                    disabled
                    type="text"
                    v-model="booking.booking_status.data.user.data.name"
                    class="form-control"
                  />
                </div>
              </div>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  >{{errors.has('number_guest') ? errors.first('number_guest') : 'Số khách *'}}</label>
                  <input
                    name="number_guest"
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label :style="errors.has('name_received') ? 'color:red;' : ''">
                    {{errors.has('name_received')
                    ? errors.first('name_received') : 'Tên người nhận *'}}
                  </label>
                  <input
                    name="name_received"
                    v-validate="'required'"
                    data-vv-as="Tên người nhận"
                    type="text"
                ...
                <div class="form-group col-md-6">
                  <label :style="errors.has('phone_received') ? 'color:red;' : ''">
                    {{errors.has('phone_received')
                    ? errors.first('phone_received') : 'Số điện thoại *'}}
                  </label>
                  <input
                    name="phone_received"
                    type="text"
                    data-vv-as="Số điện thoại"
                    v-validate="'required|numeric'"
                    v-model="booking.phone_received"
                    class="form-control"
                  />
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label :style="errors.has('email_received') ? 'color:red;' : ''">
                    {{errors.has('email_received')
                    ? errors.first('email_received') : 'Email *'}}
                  </label>
                  <input
                    name="email_received"
                    data-vv-as="Email"
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  >{{errors.has('booking_source') ? errors.first('booking_source') : 'Nguồn liên hệ *'}}</label>
                  <multiselect
                    :allow-empty="false"
                    name="booking_source"
                    v-model="source"
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  >{{errors.has('additional_fee')? errors.first('additional_fee') : 'Phụ thu'}}</label>
                  <input
                    name="additional_fee"
                    data-vv-as="Phụ thu"
